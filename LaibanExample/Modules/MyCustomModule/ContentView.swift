...
struct ContentView: View {
    ...
    @State private var positivePrompt: String = "bug, insect, beetle, ant, bee, masterpiece, highres, photorealistic, realistic, photography, soft lighting, Nikon RAW Photo, Fujifilm XT3, best quality, simple background, solid color background, white background, bright background, sharp, focus, centered, full view, sfw"
